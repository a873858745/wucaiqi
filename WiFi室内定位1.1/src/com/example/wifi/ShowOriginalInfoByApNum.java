...
public class ShowOriginalInfoByApNum extends ListActivity {
	private ListView lv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		database = new WifiDatabase(ShowOriginalInfoByApNum.this);
//		List<WifiInfomation> wifiInfoList = originalApInfoDAO
//		List<WifiInfomation> wifiInfoList = database.getOriginalApInfoById(id);//通过id查找
//		List<WifiInfomation> wifiInfoList = database.getOriginalApWifiInfoByIdAndAp(id, "ap1");
		List<WifiInfomation> wifiInfoList = database.getOriginalApWifiInfoByAp("ap1");//通过ap的序号查找
